<x-layout>
    ...
    @if ($id == 1)
        <form class="flex flex-col w-[80%] py-10 mx-auto gap-10" action="/auth/user/first-complete" method="POST"
            enctype="multipart/form-data">
            @csrf
            <div class="relative">
                <!-- sign up header -->
                <div class="w-[100%] text-center">
                    <h3 class="text-3xl text-blue-800 font-bold">Complete your Profile</h3>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img src="{{ auth()->user()->imageUrl }}" alt="" id="preview">
                        </div>
                        <!-- upload -->
                        <div class="mt-[20px] h-[50px] w-[250px] rounded-xl flex justify-center items-center">
                            ...
                            <label class="flex items-center cursor-pointer text-button-800" for="image">
            ...
            <div class="flex flex-col gap-10">
                <div class="mx-4 p-4">
                    <div class="flex items-center">
                        <div class="flex items-center text-blue-400 relative">
                            <div
                                class="absolute flex items-center justify-center w-12 h-12 bg-blue-400 rounded-full -start-4 ring-4 ring-blue-50 dark:ring-gray-900 dark:bg-green-900">
                                <svg class="w-3.5 h-3.5 text-blue-100 dark:text-blue-400" aria-hidden="true"
                        ...
                        <div class="flex-auto border-t-2 transition duration-500 ease-in-out border-blue-400"></div>
                        <div class="flex items-center text-blue-400 relative">
                            <div
                                class="absolute flex items-center justify-center w-12 h-12 bg-blue-400 rounded-full -start-4 ring-4 ring-blue-50 dark:ring-gray-900 dark:bg-green-900">
                                <svg class="w-3.5 h-3.5 text-blue-100 dark:text-blue-400" aria-hidden="true"
                ...
                <div class="w-full flex justify-end">
                    <button type="submit" href="/complete-your-profile/2"
                        class="animate-bounce w-[3.2rem] h-[3.2rem] focus:ring-4 focus:ring-blue-400 flex items-center justify-center rounded-full bg-blue-400 mr-6 text-white">Next</button>
                </div>
            </div>
        </form>
    @else
        <form class="flex flex-col w-[80%] py-10 mx-auto gap-10" action="/auth/user/second-complete" method="POST">
                ...
                <div class="w-[100%] flex justify-center items-center md:pt-[50px] pt-[30px] lg:px-[0px] md:px-[100px]">
                    <div
                        ...
                        @foreach ($genres as $gen)
                            <div class="h-[250px] w-[250px]  border-none rounded-xl px-[10px] bg-gray-50"
                                ...
                                <div class="flex h-[70px] w-[100%]">
                                    <div
                                        ...
                                        <img src="{{ $gen->image }}" alt="" class="w-[30px] h-[30px] rounded-full ">
                                    </div>
                                </div>
                                <!-- header and p tab -->

                                <div class="h-[100px] w-[100%]">
                                    <h4 class="mb-[10px] font-bold text-lg text-button-800">{{ $gen->name }}</h4>
            ...
            <div class="flex flex-col gap-10">
                ...
                <div class="w-full flex justify-end">
                    <button type="submit"
                        class="animate-bounce w-[3.6rem] h-[3.6rem] focus:ring-4 focus:ring-blue-400 flex items-center justify-center rounded-full bg-blue-400  text-white">Finish</button>
                </div>
            </div>
        </form>
