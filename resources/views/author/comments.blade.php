                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                ...
                                @if ($review->isCommented(auth()->user()))
                                    <i class='fas fa-check-circle  ml-2 text-lg text-green-400'></i>
                                @else
                                    <i class='fas fa-clock ml-2 text-lg text-yellow-400'></i>
                                @endif
                            ...
                            <td class="px-6 py-4">
                                ...
                                <a href="/book-details/{{ $review->book->slug }}" type="button"
                                    ...
                                    class="font-medium text-blue-600 dark:text-blue-500">show</a>
                                <a href="#" data-modal-target="progress-modal-{{ $review->id }}"
                                    data-modal-toggle="progress-modal-{{ $review->id }}"
