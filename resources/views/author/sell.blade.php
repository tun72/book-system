                    ...
                    <div class="py-6 border-b border-gray-100 dark:border-gray-800">
                        <div class="w-full md:w-10/12">
                            <div class="flex flex-wrap mb-2 -m-3">
                                <div class="w-full p-3 md:w-1/3">
                                    <p class="text-sm font-semibold text-gray-800 dark:text-gray-400">Payment details
                                    </p>
                                </div>
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="w-full p-3 md:flex-1">
                                    <p class="mb-1.5 font-medium text-base text-gray-800 dark:text-gray-400">Phone
                                        Number</p>
                                    <input name="phoneNumber" value="{{ old('phoneNumber') }}"
                                        class="w-full px-4 py-2.5 dark:bg-gray-800 dark:border-gray-800 dark:placeholder-gray-500 dark:text-gray-400  text-base text-gray-900 rounded-lg font-normal border border-gray-200"
                            ...
                            <div class="flex flex-wrap">
                                <div class="w-full p-3 md:w-1/3"></div>
                                <div class="w-full p-3 md:flex-1">
                                    <p class="mb-1.5 font-medium text-base text-gray-800 dark:text-gray-400">Account
                                        Name</p>
                                    <input name="accname" value="{{ old('name') }}"
                                        class="w-full px-4 py-2.5 dark:bg-gray-800 dark:border-gray-800 dark:placeholder-gray-500 dark:text-gray-400  text-base text-gray-900 rounded-lg font-normal border border-gray-200"
                                        type="text" placeholder="Account Name">
                                    <x-error :name="'accname'" />
                                </div>
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="w-full p-3 md:flex-1"> <label
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="file_input">Upload QRCODE(optional)</label>
                                    <input name="qrcode"
                        ...
                        <div class="w-full md:w-10/12">
                            <div class="flex flex-wrap -m-3">
                                ...
                                <div class="w-full p-3 md:flex-1">
                                    <input disabled
                                        class="w-full px-4 py-2.5 dark:bg-gray-800 dark:border-gray-800 dark:placeholder-gray-500 dark:text-gray-400  text-base text-gray-900 rounded-lg font-normal border border-gray-200"
                                        type="email" placeholder="adam@gmail.com" value="{{ auth()->user()->email }}">
                                </div>
                            </div>
                        </div>
                    </div>
