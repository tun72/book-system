<x-home-layout>
    <div class="mx-auto">
        <h3 class="text-3xl mb-5 text-button-800"><i class="fas fa-fire-alt me-2"></i>Top Trend</h3>
        <!-- Book Cards -->
                ...
                <div class="flex gap-4" data-modal-target="default-modal-{{ $book->id }}"
                    ...
                    <div class="flex flex-col gap-2 w-[50%] flex-auto">
                        ...
                        <div class="flex gap-2 items-center">
                            <span class="w-fit px-2 py-1 bg-green-400 text-sm font-semibold text-green-100 rounded-md">
                                {{ $book->status }}
                            </span>
