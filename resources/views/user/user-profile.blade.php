<x-user-layout>
    ...
    <!-- Nav -->
    <div class="px-[100px] w-[100%] mt-[10px] flex justify-between items-center mb-5">
        <!-- nav items -->
        <div class="">
            <ul class="flex justify-normal gap-[30px] items-center">
                <li class="font-semibold text-xl" style="cursor: pointer">
                    <a href="User Profile-About.html">About</a>
                </li>
                <li class="font-semibold text-xl" style="cursor: pointer">
                    <a href="User Profile-Following.html">Following</a>
                </li>
            </ul>
        </div>
        <!-- tools -->
    ...
    <!-- About Start -->
    <div class="px-[20px]  w-[100%] flex gap-[30px] mb-10">
        <!-- first card -->
        <!-- first part -->
        <div class="h-[320px] basis-[30%] rounded-lg bg-white"
            style="
            ...
            <div class="flex justify-center items-center w-[100%] mt-[10px]">
                <button class="h-[40px] w-[140px] bg-[#ff6122] rounded-lg text-white text-md font-bold">
                    Verify
                </button>
            </div>
            <div class="mt-[10px] px-[10px]">
                <span class="font-sm font-semibold">Joined</span><span class="font-sm text-light"> 4 minutes ago</span>
            </div>
            <!-- middle part -->
            ...
            <div class="px-[10px]">
                ...
                <div class="flex gap-[10px] mt-[10px]">
                    <div
                        class="h-[40px] w-[40px] rounded-full bg-[yellow] bg-[url('https://images5.alphacoders.com/122/1226979.jpg')] bg-center bg-cover bg-no-repeat">
                    </div>
                    <div
                        class="h-[40px] w-[40px] bg-[blue] rounded-full bg-[url('https://c4.wallpaperflare.com/wallpaper/836/295/628/kono-subarashii-sekai-ni-shukufuku-wo-aqua-konosuba-wallpaper-preview.jpg')] bg-center bg-cover bg-no-repeat">
                    </div>
                </div>
                <div class="h-[1px] bg-gray-300 w-[100%] mt-[10px] mb-[10px]"></div>
            </div>
        ...
        <div class="flex-auto h-[100%] rounded-xl  bg-white"
            ...
            <div class="w-[100%] mt-[10px] px-[2rem]  flex justify-between items-center">
                <h1 class="text-2xl font-semibold">1 Reading List</h1>
                <div class="flex gap-[5px]" style="cursor: pointer">
                    <svg class="text-[#6f6f6f]" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                        viewBox="0 0 24 24">
            ...
            @foreach (auth()->user()->readLists as $readlist)
                <div class="px-[2rem] mt-[10px]">
                    <a href="" class="flex mb-[10px] mt-[10px]">
                        ...
                        <svg class="text-[#6f7179]" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                            viewBox="0 0 24 24">
                            <path fill="currentColor" d="M8.59 16.59L13.17 12L8.59 7.41L10 6l6 6l-6 6z" />
                        </svg>
                    </a>

                    <span class="text-sm text-light">Reading List . {{ count($readlist->books) }} Books</span>
                </div>
                @php
                ...
                <div class="w-[100%] px-[2rem] mt-[10px]  pb-[2rem] flex items-center gap-10">
                    @foreach ($readlist->books as $book)
                        <!-- first list  -->
                        <a href="#" data-modal-target="default-modal-{{ $readlist->id }}-{{ $book->id }}"
