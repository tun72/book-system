<x-layout>
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                            ...
                            <li>
                                <a href="/admin/authors/request"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Author
                                    Requests</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Coins</span>
                            <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                            <li>
                                <a href="/admin/users/coins/buy"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Buy
                                    Coins</a>
                            </li>
                            <li>
                                <a href="/admin/users/coins/sell"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Sell
                                    Coins</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Incomes</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul id="dropdown-books" class="hidden py-2 space-y-2">
                            <li>
                                <a href="/admin/books"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Books</a>
                            </li>
                            <li>
                                <a href="/admin/books/genres"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Genres</a>
                            </li>
                            <li>
                                <a href="//admin/books/reports"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Reports</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <main class="p-4 md:ml-64  pt-20 pb-10 bg-brand-50 overflow-y-scroll h-[100vh] ">
