    ...
    <div class="grid grid-cols-[14rem_1fr] grid-rows-[auto_1fr] ">
        <nav class="bg-white flex justify-end p-[0.5rem_3.8rem] items-center border-b-1 border-gray-800 ">
            ...
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full" src="{{ auth()->user()->imageUrl }}" alt="user photo" />
            </button>
            <!-- Dropdown menu -->
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="/admin/admin-setting"
                            ...
                            <span class="ml-3">Admin Setting</span>
                        </a>
                    ...
                    <li>
                        <a href="/admin/authors/request"
                            ...
                            <span class="ml-3">Request Authors</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/admin/users/coins/buy"
                            ...
                            <span class="ml-3">Buy Coins</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/admin/books/reports"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path
                                    d="M336.2 80c-49.1 0-93.3-32-161.9-32-31.3 0-58.3 6.5-80.7 15.2a48 48 0 0 0 2.1-20.7C93.1 19.6 74.2 1.6 51.2 .1 23.2-1.7 0 20.4 0 48c0 17.8 9.7 33.3 24 41.6V496c0 8.8 7.2 16 16 16h16c8.8 0 16-7.2 16-16v-83.4C109.9 395.3 143.3 384 199.8 384c49.1 0 93.3 32 161.9 32 58.5 0 102-22.6 128.5-40C503.8 367.2 512 352.1 512 335.9V95.9c0-34.5-35.3-57.8-66.9-44.1C409.2 67.3 371.6 80 336.2 80zM464 336c-21.8 15.4-60.8 32-102.3 32-59.9 0-102-32-161.9-32-43.4 0-96.4 9.4-127.8 24V128c21.8-15.4 60.8-32 102.3-32 59.9 0 102 32 161.9 32 43.3 0 96.3-17.4 127.8-32v240z" />
                            </svg>
